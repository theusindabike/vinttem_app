...
class TransactionDetailForm extends StatelessWidget {
  const TransactionDetailForm({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              MultiChoiceChips<TransactionUser>(
                key: const Key('TransactionDetailForm_user_wrap'),
              ...
              MultiChoiceChips<TransactionCategory>(
                key: const Key('TransactionDetailForm_category_wrap'),
              ...
              MultiChoiceChips<TransactionType>(
                key: const Key('TransactionDetailForm_type_wrap'),
              ...
              TextFormField(
                key: const Key('TransactionDetailForm_description_textField'),
    ...
    return BlocBuilder<TransactionCreateBloc, TransactionCreateState>(
      builder: (context, state) {
        ...
        return TextFormField(
          key: const Key('TransactionDetailForm_value_textField'),
    ...
    return BlocBuilder<TransactionCreateBloc, TransactionCreateState>(
      builder: (context, state) {
        return ElevatedButton(
          key: const Key('TransactionDetailForm_clean_raisedButton'),
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TransactionCreateBloc, TransactionCreateState>(
      builder: (context, state) {
        ...
        return ElevatedButton(
          key: const Key('TransactionDetailForm_save_raisedButton'),
